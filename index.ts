...
class Person{
  ...
  constructor(newName:string, newAge:number,something:string){
    this.name = newName;
    this.age = newAge;
...
class Developer extends Person{
  ...
  constructor(newName:string, newAge:number, something:any, language:any){
    super(newName,newAge,something);
